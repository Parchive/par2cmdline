...
#ifdef _OPENMP
  bool Open(CommandLine::NoiseLevel noiselevel, std::ostream &sout, std::ostream &serr, const CommandLine::ExtraFile &extrafile, u64 blocksize, bool deferhashcomputation, string basepath, u64 totalsize, u64 &totalprogress);
#else
  bool Open(CommandLine::NoiseLevel noiselevel, std::ostream &sout, std::ostream &serr, const CommandLine::ExtraFile &extrafile, u64 blocksize, bool deferhashcomputation, string basepath);
#endif
  void Close(void);
