...
//    return 1;
...

  {
    ...
    if (DiskFile::TranslateFilename("input1.txt") != "input1.txt") {
      cout << "TranslateFilename 1" << endl;
      return 1;
    }
    /*
TODO: The function needs to be fixed and these tests uncommented.
    if (DiskFile::TranslateFilename("<") == "<") {
