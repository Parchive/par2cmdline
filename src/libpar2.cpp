...
Par2Verifier::Par2Verifier(const std::string &_basepath, const Backends &_backends)
...
Par2Creator::Par2Creator(const std::string &_basepath, const Backends &_backends)
: nullstream(new NullStream)
, sout(*nullstream)
, serr(*nullstream)
, noiselevel(nlSilent)
